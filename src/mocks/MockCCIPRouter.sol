...
contract MockCCIPRouter {
    ...
    uint64 public nextSourceChainSelector;
    ...
    function setNextSourceChainSelector(uint64 _nextSourceChainSelector) external {
        nextSourceChainSelector = _nextSourceChainSelector;
    }
}
